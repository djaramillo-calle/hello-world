...
Season tooling: `python3 scripts/dial.py` (dial recommendation),
`python3 scripts/weekly-rollup.py --set conversations=2 listening_days=5`
(Friday log), `python3 scripts/build-progress.py` (rebuild the board).
