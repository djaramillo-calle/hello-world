...
| `docs/LAUNCH.md` · `launch.html` | The ordered checklist to a first working version of the whole system (phone, Mac, coach, season); the published copy keeps its ticks. |
