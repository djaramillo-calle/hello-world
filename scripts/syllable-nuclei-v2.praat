...
form Counting Syllables in Sound Utterances
   ...
   real Minimum_pause_duration_(s) 0.4
   real Minimum_sounding_duration_(s) 0.1
   boolean Keep_Soundfiles_and_Textgrids yes
   sentence directory /home/john/folder
   sentence fileName audiofile.wav
endform
...
# summarize results in Info window
   ...
   printline "syllableCount": "'voicedcount'",
   printline "pauseCount": "'npause'",
   printline "totalDuration": "'originaldur:2'",
   printline "speakingTotalDuration": "'speakingtot:2'",
   printline "speakingRate": "'speakingrate:2'",
   printline "articulationRate": "'articulationrate:2'",
   printline "averageSylableDuration": "'asd:3'",
