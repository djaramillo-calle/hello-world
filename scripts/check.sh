...
echo "== python tooling =="
for s in dial weekly-rollup build-progress hub-fold listening-pull anki-revlog intervals-push daily-readout elevenlabs-pull practice-review anki-push-cards azure-check practice-ingest passage-import library-sync koreader-pull reading-cards reading-hub anki-cloud drive cloud-sync; do
