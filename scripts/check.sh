...
echo "== python tooling =="
for s in dial weekly-rollup build-progress hub-fold listening-pull anki-revlog intervals-push daily-readout elevenlabs-pull practice-review anki-push-cards azure_pa azure-check practice-ingest passage-import library-sync koreader-pull reader-pull reading-cards reading-hub anki-cloud drive cloud-sync; do
