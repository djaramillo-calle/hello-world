...
echo "== python tooling =="
for s in dial weekly-rollup build-progress hub-fold listening-pull anki-revlog intervals-push daily-readout elevenlabs-pull practice-review anki-push-cards azure-check practice-ingest passage-import kindle-hub; do
